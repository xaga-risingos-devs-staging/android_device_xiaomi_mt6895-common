...
PRODUCT_PACKAGES += xagaperformanced
PRODUCT_COPY_FILES += \
    device/xiaomi/mt6895-common/performanced/init.xagaperformanced.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.xagaperformanced.rc
